...
* **`core/`**: OSGi bundles, services, listeners, servlets, and core business models.
* **`ui.config/`**: Runmode-specific OSGi configuration packages.
* **`dispatcher/`**: Cloud Manager dispatcher configurations.
...
# Auto-install to local AEM Author instance (port 4502)
